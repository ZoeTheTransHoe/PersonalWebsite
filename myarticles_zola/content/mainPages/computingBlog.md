...
<html>
  <head>
    ...
    <title>Welcome To The Land Of Zoey!</title>
    ...
    <link href="/css/computingBlog.css" rel="stylesheet" type="text/css" media="all">
  </head>
  <body>
    <div id="navBar"></div>
        <main>
          <div class="catHeader">
            ...
            <div class="projects">
              ...
              <div>
                <img src="/myarticles_zola/static/img/Computing/Flatpak.svg" class="projectImage">
                <p class="name"> Flatpak.</p>
            ...
            <div>
              <h3></a href="https://github.com/ZoeTheTransHoe/Gnome-Stories">Git Link To Gnome Stories.</a></h3>
              <p>This is where I'll upload my progress with learning the Rust Porgramming Language and GTK app development.</p>
              <p>Using my knowledge in Rust and Python, and my love for GNOME and Libadwita apps, I am making simple apps of my own.</p>
            </div>
        </main>
    </body>
